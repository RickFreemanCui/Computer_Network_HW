...
class TCPFlagsDialog(QDialog):
    flagsValue = 0
    initFlagsValue = 0
    def __init__(self, returnFlagsValueList, parent, initFlagsValue):
        super(TCPFlagsDialog, self).__init__(parent)

        self.ui = Ui_Dialog()
        self.ui.setupUi(self)
        self.flagsValue = initFlagsValue
        self.initFlagsValue = initFlagsValue
        self.returnFlagsValueList = returnFlagsValueList
        self.initCheckBox()
        self.doConnect()
    ...
    def handleOKClicked(self):
        self.returnFlagsValueList[0] = self.flagsValue
        self.accept()
    
    def handleCancelClicked(self):
        self.returnFlagsValueList[0] = self.initFlagsValue
        self.reject()
...
def main():
    ...
    returnFlagsValueList = [1]
    win = QMainWindow()
    diag = TCPFlagsDialog(returnFlagsValueList, win, 24)
    win.show()
    app.exec_()
    print(returnFlagsValueList)
